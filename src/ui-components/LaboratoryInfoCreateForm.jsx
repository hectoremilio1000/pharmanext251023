...
export default function LaboratoryInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LaboratoryInfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LaboratoryInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Code"
